    ...
    return (
        ...
        <div className="w-full h-1/2 p-6 flex flex-col justify-center">
            <div className="flex flex-wrap justify-between mb-4">
                ...
                <h3 className="text-2xl font-inter text-black text-right">{location}</h3>
            </div>
            ...
            {/* Book Now Button */}
            <button className="px-4 py-2 w-3/4 mx-auto mb-3 bg-emerald-700 text-white text-lg font-medium rounded-2xl hover:bg-emerald-600 transition cursor-pointer">
                Book Now
            </button>
        </div>
